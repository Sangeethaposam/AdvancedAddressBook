package com.bridzelabz.advanceAddressbook;
	...
	public class AddressBook {
	    ...
	    private static boolean findDuplicates(String firstName) {

	        return contactList.stream().anyMatch(contact ->contact.getfirstName().equals(firstName));
	    }
	    @Override
	    ...
	    public void editContact() {
	        ...
	        for (Contact contactPerson : contactList) {
	            if (firstName.equals(contactPerson.getfirstName())) {
	    ...
	    public void addAddressBookMap(AddressBook ad) {
	        ...
	        addressBookMap.put(firstName, ad);
	    }
	    ...
	    public ArrayList createNewAddressBook() {
	            ...
	            switch (operation) {
	                ...
	                case 3:
	                    ...
	                    for (String addressBookName : addressBookNames.keySet()) {
	                        ...
	                        contact2.stream().filter(firstName -> firstName.getfirstName().equalsIgnoreCase(personName))
	                                .forEach(x -> System.out.println(x));
	                    }
	                    break;
	                case 4:
